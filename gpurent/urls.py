...
from leases.views import LeaseViewSet, admin_live_alerts_endpoint, admin_live_dashboard_endpoint
...
urlpatterns = [
    ...
    path("admin/api/live-dashboard/", admin_live_dashboard_endpoint, name="admin_live_dashboard"),
